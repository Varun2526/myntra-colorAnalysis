...
const NAV_ITEMS = [
  ...
  { label: 'Genz' },
  { label: 'Studio' },
  { label: 'Fitfluent', badge: 'New', active: true },
]
...
function NavLink({ label, active, highlight, badge }) {
  return (
    ...
    >
      {badge && (
        <span className="absolute -right-0.5 top-5 translate-x-1/2 text-[10px] font-extrabold uppercase leading-none text-primary">
          {badge}
        </span>
      )}
      {label}
